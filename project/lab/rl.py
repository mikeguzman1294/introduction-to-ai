...
class ExperienceReplay(object):
    ...
    def get_batch(self, model, batch_size=10):    
        ...
        env_dim = list(self.memory[0][0][0].shape) # torch.Size([1, 29, 41, 1]) this is what you get
        env_dim[0] = min(len_memory, batch_size) # you set the first element of the tensor which corresponds to the batch size
